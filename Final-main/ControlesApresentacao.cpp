            ...
            case 1:
                ...
                { // Solicita autenticacao.
                    ...
                    while (apresentar)
                    {
                        ...
                        {
                            case 1:
                                cntrApresentacaoParticipante->executar(&email); // Solicita servico de usuario.
                                break;
                            case 2:
                                cntrApresentacaoPSS->executar(&email); // Solicita servico de hospedagem.
                                break;
                            case 3:
                                apresentar = false;
                                break;
...
void CntrApresentacaoParticipante::executar(Email *email){
    // Mensagens a serem apresentadas na tela de selecao de servico..
...
bool CntrApresentacaoParticipante::editar(Email *email) {
    string texto1 ="Preencha os seguintes campos:";
...
bool CntrApresentacaoPSS::editarHospedagem() {
    {
...
bool CntrApresentacaoPSS::editarAvaliacao() {
    {
        ...
        if (cntrSessao->editar(&avaliacao)) {
            cout << texto7 << endl; // Informa sucesso.
...
bool CntrApresentacaoPSS::incluirHospedagem() {
    {
        // Mensagens a serem apresentadas na tela de cadastramento.
        ...
        if (cntrPeca->incluir(&hospedagem)) {
            cout << texto7 << endl; // Informa sucesso.
...
bool CntrApresentacaoPSS::incluirAvaliacao(){
    // Mensagens a serem apresentadas na tela de cadastramento.
    ...
    if (cntrSessao->incluir(&avaliacao)) {
        cout << texto7 << endl; // Informa sucesso.
...
bool CntrApresentacaoPSS::excluirHospedagem() {
    {
...
bool CntrApresentacaoPSS::excluirAvaliacao() {
    {
        // Mensagens a serem apresentadas na tela de descadastramento.
...
void CntrApresentacaoPSS::executar(Email *email){
    string texto1 = "Selecione um dos servicos : ";
